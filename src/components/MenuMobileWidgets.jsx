        ...
        <div>
            <div className="grid-container">
                ...
                <div className="grid-item">
                    <Link className='menu-btn' to="vinos" smooth={true} duration={0} href="#vinos">
                        <img src={vinos} alt="Categoria del Menu de vinos" loading="lazy" />
                        VINOS</Link>
                </div>
                <div className="grid-item">
                    <Link className='menu-btn' to="picadas" smooth={true} duration={0} href="#picadas">
                        <img src={picadas} alt="Categoria del Menu de picadas" loading="lazy" />
                        PICADAS</Link>
                </div>
                <div className="grid-item">
                    <Link className='menu-btn' to="bebidas" smooth={true} duration={0} href="#bebidas" >
                        <img src={bebidas} alt="Categoria del Menu de bebidas" loading="lazy" />
                        BEBIDAS</Link>
                </div>
                <div className="grid-item">
                    <Link className='menu-btn' to="sandwiches" smooth={true} duration={0} href="#sandwiches" >
                        <img src={sandwichs} alt="Categoria del Menu de sandwichs" loading="lazy" />
                        SANDWICHS</Link>
                </div>
                <div className="grid-item">
                    <Link className='menu-btn' to="burgers" smooth={true} duration={0} href="#burgers" >
                        <img src={burgers} alt="Categoria del Menu de burgers" loading="lazy" />
                        BURGERS</Link>
                </div>
                <div className="grid-item">
                    <Link className='menu-btn' to="promociones" smooth={true} duration={0} href="#promociones" >
                        <img src={promos} alt="Categoria del Menu de promos" loading="lazy" />
                        PROMOS</Link>
                </div>
                <div className="grid-item">
                    <Link className='menu-btn' to="postres" smooth={true} duration={0} href="#postres">
                        <img src={postres} alt="Categoria del Menu de postres" loading="lazy" />
                        POSTRES</Link>
                </div>
                <div className="grid-item">
                    <Link className='menu-btn' to="forever young" smooth={true} duration={0} href="#forever young">
                        <img src={tragos} alt="Categoria del Menu de tragos" loading="lazy" />
                        TRAGOS</Link>
                </div>
                <div className="grid-item">
                    <Link className='menu-btn' to="speakeasy licor scotch" smooth={true} duration={0} href="#speakeasy licor scotch" >
                        <img src={whiskys} alt="Categoria del Menu de whiskys" loading="lazy" />
                        WHISKYS</Link>
                </div>
                <div className="grid-item">
                    <Link className='menu-btn' to="ensaladas" smooth={true} duration={0} href="#ensaladas">
